...
(() => {
  ...
  const usageColors = ["#5645d4", "#2a9d99", "#dd5b00", "#ff64c8", "#0075de", "#a4a097"]; // Notion spectrum: purple/teal/orange/pink/blue; stone = 其他
  ...
  function renderUsageModels(data, models, series) {
    ...
    svg.append(svgNode("circle", { cx: 110, cy: 110, r: radius, fill: "none", stroke: "#ede9e4", "stroke-width": 24 }));
    let offset = 0;
    const ranking = [];
